...
$dadosboleto["nosso_numero"] = sprintf('%08d', $boleto['id']);  // Nosso numero - REGRA: Máximo de 8 caracteres!
...
$dadosboleto["demonstrativo1"] = "Pagamento Guimarães e Nobrega Advocacia";
$dadosboleto["demonstrativo2"] = "Referente a ….<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo3"] = "http://helpconsumidor.com.br";
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 5% após o vencimento e juros de 5% ao mes.";
$dadosboleto["instrucoes2"] = "- Receber até 30 dias após o vencimento - Taxa de R$ 7,00 pela 2a via deste boleto.";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: financeiro@guimaraesenobrega.com.br";
...
$dadosboleto["cedente"] = "Guimarães e Nóbrega Advocacia";
