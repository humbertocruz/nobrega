...
<div class="row">
	<div class="col-md-2">
		<ul class="list-group">
			<li class="list-group-item"><a href="/sys/Sacados/index" class="btn btn-default btn-block">Voltar</a></li>
		</ul>
	</div>
	<div class="col-md-10">
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if(!empty($Sacado['DocumentoOut'])) { ?>
		<div class="panel panel-success">
			<div class="panel-heading">
				<h2 class="panel-title">Documentos</h2>
			</div>
			<div class="panel-body">
				<?php echo $this->Html->link('Contrato', array('action'=>'documentos', 'contrato', $Sacado['Sacado']['id']), array('class'=>'btn btn-default')); ?>
				<?php echo $this->Html->link('Procuração', array('action'=>'documentos', 'procuracao', $Sacado['Sacado']['id']), array('class'=>'btn btn-default')); ?>
			</div>
		</div>
		<?php } ?>
		...
		<div class="panel panel-warning">
			...
			<div class="panel-footer">
				<?php echo $this->Bootstrap->btnLink('Novo',array('controller'=>'Sacados','action'=>'novo_boleton'),array('style'=>'primary'));?>
			</div>
		</div>
	</div>
</div>
