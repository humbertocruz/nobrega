...
<?php $this->start('title');?>Clientes em Atraso (Boletos Novos)<?php $this->end(); ?>
...
<?php $this->start('table-body'); ?>
	...
	<tr>
		<td><?php echo $this->Html->link( $boletos['Sacado']['nome_razaosocial'], array('controller'=>'Sacados','action'=>'view',$boletos['BoletosNovo']['sacado_id'])); ?>
